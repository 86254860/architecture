...
- [ ] **Slack**: Announce Feature Freeze to `#hyperfleet-releases`
  ...
  ✅ CI pipeline ((nightly E2E testing)) are green
...
- [ ] All E2E testng jobs are passed
...
- Release notes for each HyperFleet Release aggregating component changes (`RELEASE/RELEASE-NOTES-vX.Y.md`) from a high level and summarized/simplified until release 1.0 (this requirement might also be cancelled)
